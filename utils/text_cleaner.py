...
STOPWORDS = set([
    ...
    '많이', '다만', '약간', '뭔가', '조금','쪼금', '다소',
    '해당', '자체', '이상', '이하', '통해', '위해', '대한', '그냥', '계속', '아주', '엄청', '완전', '살짝', '하나','한가지','약간은',
    '배송', '빠른', '배송도', '빠르고', '배송이', '빠른배송', '배송빠르고', '빨라서','빠름',
    '쓰던게', '쓰다가', '쓰다', '기기', '기계가', '기기가', "쓰던거",'사용하는데','사용하다가','사용하던게','쓰던제품',
])
